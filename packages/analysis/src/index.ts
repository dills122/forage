...
export const defaultCategoryRules: CategoryRule[] = [
  ...
  },
  {
    ...
    threshold: 3,
    topics: terms(["cli", "lint", "automation", "validation", "formatter", "compiler", "sdk"], 2),
    keywords: terms(["cli", "tool", "developer", "automation", "lint", "build", "compiler"], 2),
  },
  {
    id: "devops",
    label: "DevOps",
    family: "devops",
    threshold: 3,
    topics: terms(["docker", "kubernetes", "terraform", "ci", "cd", "deploy", "observability"], 2),
    keywords: terms(["deploy", "container", "infrastructure", "pipeline", "monitoring"], 2),
  },
  {
    id: "data",
    label: "Data",
  ...
  },
  {
    ...
    threshold: 3,
    topics: terms(["docs", "documentation", "mdx", "markdown", "static-site"], 2),
    keywords: terms(["documentation", "docs", "guide", "manual", "markdown"], 2),
  },
  {
    id: "security",
    label: "Security",
  ...
  },
  {
    ...
    family: "learning",
    threshold: 3,
    topics: terms(["awesome", "tutorial", "learning", "examples", "course"], 2),
    keywords: terms(["awesome", "tutorial", "learn", "examples", "guide"], 2),
  },
  {
    id: "library",
    label: "Library",
